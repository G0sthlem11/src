...
class Commander(Node):
    ...
    def __init__(self):
        ...
        self.vel = np.array([0,0,0,0,0,0], float) #left_front, right_front, left_rear, right_rear
    ...
    def timer_callback(self):
        ...
        if(mode_selection == 1):
            ...
            self.vel[3] = -self.vel[0]
            self.vel[4] = -self.vel[0]
            self.vel[5] = -self.vel[0]
        ...
        # in-phase
            ...
            self.pos[2] = -math.atan(ang)
            self.pos[3] = math.atan(ang)
